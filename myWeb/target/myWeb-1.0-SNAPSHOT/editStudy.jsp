            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" action="ServletStudy" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input class="form-control form-control-user"
                                           name="score" placeholder="输入分数...">
                                </div>
                                <div class="col-sm-6">
                                    <input class="form-control form-control-user"
                                           name="credit" placeholder="输入学分...">
                                </div>
                            </div>
                        ...
                        <form class="user" action="ServletStudy" method="get">
