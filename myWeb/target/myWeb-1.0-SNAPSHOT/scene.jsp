...
<%@ page import="com.dao.SceneDAO" %>
<%@ page import="com.entity.Scene" %>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">美景</h1>
                </div>
                ...
                <div>
                    ...
                    %>
                    <a href="editScene.jsp" class="btn btn-primary btn-icon-split" id="button1">
                ...
                <%
                    ...
                    List<Scene> list1 = sceneDAO.readScene();
