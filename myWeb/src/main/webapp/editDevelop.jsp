            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" action="ServletDevelop" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control form-control-user"
                                           name="name" placeholder="开发技能名称...">
                                </div>
                            </div>

                            <div class="form-group">
                                <input class="form-control form-control-user" name="level"
                                       placeholder="开发技能水平...">
                            </div>
                        ...
                        <form class="user" action="ServletDevelop" method="get">
