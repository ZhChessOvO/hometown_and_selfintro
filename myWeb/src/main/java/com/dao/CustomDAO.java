...
public class CustomDAO {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if(rs.getString("img")==null){
                    custom = new Custom(id,name,info);
                }else{
                    custom = new Custom(id,name,info,rs.getString("img"));
                }
    ...
    public void addCustom(int id1, String name1, String info1, String img1){
        Connection con = null;
        PreparedStatement psmt = null;
        ResultSet rs = null;
        try {
...
//            System.out.println(sql);
    ...
    public void editCustom(int id1, String name1, String info1, String img1){
        Connection con = null;
        PreparedStatement psmt = null;
        ResultSet rs = null;
        try {
